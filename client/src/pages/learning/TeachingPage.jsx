      ...
      <div className="p-7">
        ...
        <div className="mt-auto pt-4 border-t border-slate-100">
          <Link to={`/app/teach/${course.id}/materials`}
            className="flex items-center justify-center gap-2 w-full px-4 py-3 bg-[#0B5E3C] hover:bg-emerald-800 text-white rounded-xl font-black text-xs uppercase tracking-widest shadow-sm transition-all">
            <FolderOpen className="w-4 h-4 text-amber-400" /> Manage Files &amp; Resources
          </Link>
        </div>
      </div>
    </div>
...
function TeachingPage() {
  ...
  return (
    <div className="space-y-12 pb-24 max-w-7xl mx-auto">
      ...
      {/* ════════════════════════════════════════════════════════════════════════
          SECTION: MANAGE LEARNING MATERIALS
      ════════════════════════════════════════════════════════════════════════ */}
