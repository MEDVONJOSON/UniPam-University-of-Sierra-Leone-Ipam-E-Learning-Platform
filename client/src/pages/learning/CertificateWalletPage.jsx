...
function CertificateWalletPage() {
  ...
  const inputClass = "block w-full pl-11 pr-4 py-3 border border-slate-200 rounded-xl bg-slate-50 text-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-slate-900";
    ...
    <div className="space-y-8 pb-16">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-extrabold text-[#0d2d57]">Certificate Wallet</h1>
            <p className="text-slate-500 text-sm">Upload, manage, and share your achievements</p>
          </div>
        </div>
        <button
          onClick={() => setShowUpload(!showUpload)}
          className="flex items-center gap-2 px-5 py-2.5 bg-[#0d2d57] text-white text-sm font-bold rounded-xl hover:bg-[#153a6d] transition-all shadow-md"
        >
      ...
      {message && (
        <div className="flex items-center gap-2 p-4 text-sm text-emerald-700 bg-emerald-50 rounded-xl border border-emerald-100">
      ...
      {showUpload && (
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
          <h2 className="text-xl font-bold text-[#0d2d57] mb-5">Upload New Certificate</h2>
          <form className="space-y-5" onSubmit={handleUpload}>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="appearance-none block w-full pl-11 pr-4 py-3 border border-slate-200 rounded-xl bg-slate-50 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all text-slate-700 cursor-pointer"
                  >
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-slate-200 rounded-xl p-6 text-center bg-slate-50 hover:border-blue-300 transition-colors">
                ...
                <input
                  ...
                  className="text-sm file:mr-4 file:px-4 file:py-2 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-600 hover:file:bg-blue-100 transition-all"
            ...
            <button
              type="submit"
              className="flex items-center justify-center gap-2 w-full py-3.5 bg-[#0d2d57] hover:bg-[#153a6d] text-white text-sm font-bold rounded-xl transition-all shadow-lg"
            >
        ...
        certificates.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-2xl border border-slate-100">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#0d2d57] text-white rounded-xl font-bold hover:bg-[#153a6d] transition-all"
            >
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <h3 className="text-base font-bold text-[#0d2d57]">{item.title}</h3>
                        <p className="text-xs text-slate-400">{item.course_title || "Not linked to a course"}</p>
                      </div>
                    </div>
                    <span className={`inline-flex items-center gap-1 text-xs font-bold px-2.5 py-1 rounded-full ${
                      item.is_public ? "bg-emerald-50 text-emerald-600" : "bg-slate-100 text-slate-500"
                    }`}>
                  ...
                  <div className="flex gap-2">
                    <a
                      ...
                      className="flex-1 flex items-center justify-center gap-2 py-2.5 text-sm font-bold text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-xl transition-colors"
                    >
